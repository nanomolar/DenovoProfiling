...
window.Chart = function(context, options){
        ...
        defaults = {
                tooltips: {
                        background: 'black',
                        events: ["mousemove", "touchstart", "touchmove", "mouseout"],
                ...
                function drawAllDataPoints(animationDecimal){
                        ...
                        for (var i=0; i<data.datasets.length; i++){
                                ...
                                if(animationDecimal >= 1 && config.showTooltips) {
                                        ...
                                        registerTooltip(ctx,{type:'circle',x:curX,y:curY,r:pointRadius},{label:data.labels[0],value:data.datasets[i].dataLabel[0]},'Radar');
                                }
                                for (var j=1; j<data.datasets[i].data.length; j++){
                                        ...
                                        if(animationDecimal >= 1 && config.showTooltips) {
                                                ...
                                                registerTooltip(ctx,{type:'circle',x:curX,y:curY,r:pointRadius},{label:data.labels[j],value:data.datasets[i].dataLabel[j]},'Radar');
                                        }
                                }
                                ctx.closePath();
